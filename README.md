...
- A full-screen introduction followed by a responsive list of all published posts, newest first. Source Code Pro is bundled and served locally, with its license in `public/fonts/source-code-pro-LICENSE.md`.
- Black `#08090b`, red `#f03535`, off-white type, and three red ASCII layers fixed behind the homepage as it scrolls. Bordered post cards sit directly over the waves.
...
- Irregular waves flow continuously. Clicks and taps create overlapping wavefronts that spread from the point of contact and fade over 2.4 seconds.
